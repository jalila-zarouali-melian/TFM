    ...
    if sub_selected == "complex":
        ...
        with st.sidebar:
            ...
            choice = st.radio("Navigation", ["Subir ficheros", "Análisis descriptivo", "Preprocesado", "Modelaje",
                                             "Generar nuevas predicciones", "Descargar modelo"])
            st.info(
                "Esta aplicación automatiza el proceso de creación de un modelo de predicción de datos para datasets con variables de respuesta binarias.")
        ...
        def obtener_columnas_orden_jerarquico(dataset):
            ...
            columnas_orden_jerarquico = st.multiselect('Elige las variables con un orden jerárquico',
            ...
            if df is not None:
                ...
                if st.button('Ejecutar preprocesado'):
                    ...
                    if columnas_orden_jerarquico:
                        st.session_state.df_clean[columnas_orden_jerarquico] = df_clean[
                            columnas_orden_jerarquico].astype(
                            'category')
